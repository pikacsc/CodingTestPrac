...
와인을 사기로 마음먹은 해를 0년 차라고 정의하고, n년 차에는 Kn+Pn² 만큼의 와인을 사는 것을 목표로 했다. K는 수빈이의 고려대 애착 정도를 나타내는 상수이고, P는 수빈이의 구매중독 정도를 나타내는 상수이다.

그렇게 수빈이는 C년 동안 열심히 와인을 모았다. (마지막 해에 산 와인의 수는 KC + PC²가 된다.)
